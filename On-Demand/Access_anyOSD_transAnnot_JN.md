...
> - _This JN uses transcript IDs to add annotation columns to your differential isoform expression output table._
...
2. Navigate to the [GL4U_RNAseq_2024_Colab README](../README.md) page and click on the "Open in Colab" icon next to "5b. RNAseq Isoform Data Analysis Any OSD - Transcript Annotation", as shown below:
   > _Notes:_
   > - _This JN uses transcript IDs to add annotation columns to your differential isoform expression output table. Since transcript IDs often have incomplete annotations, the differential isoform expression output table will likely be missing several annotations._ 
   > - _It is recommended to open the Colab notebook in a new tab so these instructions remain available._

<p align="center">
  <img src="../images/GL4U_RNAseq_Colab_README_ISOt_AnyOSD.png" width="800" height="800">
</p>

<br/> 

3. You should now see the 05b_RNAseq_analysis_isoforms_anyOSD_transAnnot_colab.ipynb jupyter notebook (JN) opened in Google Colab, as shown below:

<p align="center">
  <img src="../images/Open_ISOt_AnyOSD_JN.png" width="800" height="800">
</p>

<br/>

4. Follow the instructions in the 05b_RNAseq_analysis_isoforms_anyOSD_transAnnot_colab.ipynb JN to complete all activities. Read through the JN carefully so you do not miss any activities.
...
1. After you have completed all activities in the 05b_RNAseq_analysis_isoforms_anyOSD_transAnnot_colab.ipynb JN and saved your completed JN to your Google Drive, open [Google Drive](https://drive.google.com/drive/my-drive) in a new tab, and click "My Drive" in the left side panel, then double click on the "Colab Notebooks" folder as shown below.
...
2. In the "Colab Notebooks" folder, click on the 3 dots to the right of the "Copy of 05b_RNAseq_analysis_isoforms_anyOSD_transAnnot_colab.ipynb" file, then click "Download", as shown below, to save a copy to your computer.

<p align="center">
  <img src="../images/gd_download_05b_JN.png" width="800" height="800">
</p>
