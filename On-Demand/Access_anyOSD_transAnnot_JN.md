...
> - _This JN uses transcript IDs to add annotation columns to your differential transcript expression output table._
...
2. You should see the "Copy of 05b_RNAseq_analysis_isoforms_anyOSD_transAnnot_colab.ipynb" file in the "Colab Notebooks" folder, as shown below.

   > _Note: Since this is not a required assignment in GL4U, you do not have to upload this JN to Canvas._

<p align="center">
  <img src="../images/gd_access_05b_JN.png" width="800" height="800">
</p>
