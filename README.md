...
The GL4U Intro notebooks are designed to run in [Google Colab](https://colab.research.google.com/) and use [Google Drive](https://drive.google.com/drive/home) for file storage. A [Google account](https://accounts.google.com/) is required.
To launch a notebook, click the "Open in Colab" button next to its name.

## Contents  

### GL4U Intro JNs  
1. [Introduction to Jupyter](GL4U_Intro_JNs/01-jupyter-intro.ipynb) [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/nasa/GeneLab-Training/blob/GL4U_Intro_2024_Colab/GL4U_Intro_JNs/01-jupyter-intro.ipynb)

2. [Unix Introduction](GL4U_Intro_JNs/02-unix-intro.ipynb) [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/nasa/GeneLab-Training/blob/GL4U_Intro_2024_Colab/GL4U_Intro_JNs/02-unix-intro.ipynb)

3. [R Introduction](GL4U_Intro_JNs/03-R-intro.ipynb) [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/nasa/GeneLab-Training/blob/GL4U_Intro_2024_Colab/GL4U_Intro_JNs/03-R-intro.ipynb)
